...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-md-12">
            <form action="<?php echo e(route('planos.store')); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="required col-md-6 form-group<?php echo e($errors->has('motora_UTI') ? ' has-error' : ''); ?>">
                                ...
                                <input type="text" id="motora_UTI" name="motora_UTI" value="<?php echo e(old('motora_UTI')); ?>"
                                       maxlength="255" class="form-control">
                            ...
                            <div class="required col-md-6 form-group<?php echo e($errors->has('motora_APT') ? ' has-error' : ''); ?>">
                                ...
                                <input type="text" id="motora_APT" name="motora_APT" value="<?php echo e(old('motora_APT')); ?>"
                                       maxlength="255" class="form-control">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="required col-md-6 form-group<?php echo e($errors->has('resp_UTI') ? ' has-error' : ''); ?>">
                                ...
                                <input type="text" id="resp_UTI" name="resp_UTI" value="<?php echo e(old('resp_UTI')); ?>"
                                       maxlength="255" class="form-control">
                            ...
                            <div class="required col-md-6 form-group<?php echo e($errors->has('resp_APT') ? ' has-error' : ''); ?>">
                                ...
                                <input type="text" id="resp_APT" name="resp_APT" value="<?php echo e(old('resp_APT')); ?>"
                                       maxlength="255" class="form-control">
